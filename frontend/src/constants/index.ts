...
export const SUPPORTED_AUDIO_FORMATS = ['audio/*', 'video/*'];
...
export const GETTING_STARTED_STEPS = [
  {
    ...
    text: 'Drop the Beat',
    description:
      'Ready to jam? Click on “Upload Audio” and kick off your personal sound collection. \n 🎵 Your vibes, your library.',
  },
  {
    number: 2,
    text: 'Sort Like a Pro',
    description:
      'Keep your library tight - add categories and descriptions to find your files faster than you can say “lo-fi chill beats”. \n 📁 Organized files = happier ears.',
  },
  {
    number: 3,
    text: 'Hit Play & Vibe',
    description:
      'Kick back and let the music play. Our built-in player is here to soundtrack your moment.\n ▶️ Because silence is overrated.',
  },
];
